...
const replacements = [
  ...
  {
    from: 'bg-slate-905 hover:bg-slate-800 border border-slate-800 text-[10px] font-bold text-slate-350 hover:text-white rounded-lg flex items-center gap-1 mx-auto',
  ...
  {
    from: 'bg-slate-900 hover:bg-slate-800 border border-slate-800 text-[10px] font-bold text-slate-355 hover:text-white rounded-lg flex items-center gap-1 mx-auto',
    to: 'bg-slate-50 hover:bg-slate-100 border border-slate-200 text-[10px] font-bold text-slate-600 hover:text-slate-900 rounded-lg flex items-center gap-1 mx-auto'
  },
  {
  ...
  {
    from: 'text-rose-450 font-mono font-bold block',
  ...
  {
    from: 'text-amber-405 font-mono font-bold block',
  ...
  {
    from: 'bg-slate-955/60 border-slate-850 hover:bg-slate-900 text-slate-450',
    to: 'bg-white border border-slate-200 hover:bg-slate-50 text-slate-600'
  },
  {
  ...
  {
    from: 'text-indigo-400 bg-indigo-955/30 w-fit mx-auto px-6 py-2 rounded-2xl border border-indigo-900',
