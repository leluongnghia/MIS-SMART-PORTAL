...
const initialMinutes: Minutes[] = [
  {
    ...
    signedBy: ['Thầy Nguyễn Minh Triết', 'Thầy Dương Nam Anh', 'Thầy Vũ Tiến Đạt'],
  ...
  },
  {
    ...
    signedBy: ['Thầy Dương Nam Anh', 'Thầy Nguyễn Tiến Đạt'],
