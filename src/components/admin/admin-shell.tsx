...
const menuGroups: MenuItemGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Thời khóa biểu', href: 'class-timetable', icon: CalendarDays, moduleCode: 'ACADEMIC' },
      { label: 'Lịch công tác', href: 'staff-schedule', icon: CalendarDays, moduleCode: 'ACADEMIC' },
      { label: 'Kiểm tra & Đánh giá', href: 'exams', icon: FileText, moduleCode: 'ACADEMIC' },
      { label: 'Sổ liên lạc & Nề nếp', href: 'communication-conduct', icon: CheckSquare, moduleCode: 'ACADEMIC' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Trung tâm Ticket', href: 'tickets', icon: MessageSquare, moduleCode: 'OPERATIONS' },
      ...
      { label: 'Bán trú & Nội trú', href: 'boarding', icon: Moon, moduleCode: 'OPERATIONS' },
      { label: 'Bếp ăn & Suất ăn', href: 'meals', icon: Utensils, moduleCode: 'OPERATIONS' },
      { label: 'Y tế học đường', href: 'health', icon: HeartPulse, moduleCode: 'OPERATIONS' },
      { label: 'Tài sản & Cơ sở VC', href: 'facilities', icon: Building, moduleCode: 'OPERATIONS' },
      { label: 'Vệ sinh & Môi trường', href: 'environment', icon: CheckSquare, moduleCode: 'OPERATIONS' },
      { label: 'Kho Quy trình', href: 'knowledge', icon: BookOpen, moduleCode: 'OPERATIONS' },
