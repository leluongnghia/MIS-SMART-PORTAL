                ...
                return (
                  <motion.button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? 'border-blue-400 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-700 shadow-md ring-1 ring-blue-400/20'
                        : 'border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800 hover:border-blue-300 hover:bg-slate-50 dark:hover:bg-slate-800/50'
                    )}
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="truncate text-sm font-black text-slate-900 dark:text-slate-100">{lead.fullName}</p>
                        <p className="mt-1 text-[11px] font-semibold text-slate-500 dark:text-slate-400">
                          {lead.leadCode} · {lead.grade} · {lead.source}
                        </p>
                      </div>
                      <Badge className={cn('shrink-0 border-none text-[10px] shadow-sm', meta.bg, meta.text)}>
                        {meta.label}
                      </Badge>
                    </div>
                  </motion.button>
