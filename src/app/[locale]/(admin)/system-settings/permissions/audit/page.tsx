    ...
    <div className="space-y-6">
      <div>
        <h2 className="flex items-center gap-2 text-lg font-bold text-slate-950 dark:text-white">
          ...
          Nhật ký thay đổi (Audit) phân quyền
        </h2>
        <p className="text-sm text-slate-500">Mọi thay đổi module, vai trò, nhóm và ngoại lệ ghi đè cần có người thực hiện (actor), trạng thái trước/sau và lý do.</p>
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-slate-200 dark:border-slate-800">
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            {logs.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center text-slate-500">Chưa có nhật ký thay đổi phân quyền nào.</td>
              </tr>
            )}
          </tbody>
        </table>
