...
export const PERMISSION_MODULES = [
  ...
  { key: "meetings", label: "Quản lý Cuộc họp" },
  { key: "directives", label: "Chỉ đạo BGH" },
  { key: "announcements", label: "Thông báo nội bộ" },
  { key: "chat", label: "Chat & Giao tiếp nội bộ" },
  { key: "hrm", label: "Quản trị Nhân sự HRM" },
  { key: "kpi", label: "Quản trị KPI" },
  { key: "okr", label: "Quản trị OKR" },
  { key: "risk", label: "Quản trị Rủi ro" },
  { key: "crm", label: "Tuyển sinh & CRM" },
  { key: "admissions", label: "Hồ sơ Nhập học" },
  { key: "payments", label: "Tài chính & Học phí" },
  { key: "facilities", label: "CSVC, Thiết bị & Mua sắm" },
  { key: "students", label: "Hồ sơ Học sinh 360" },
  { key: "classes", label: "Quản lý Lớp học" },
  { key: "class-timetable", label: "Thời khóa biểu" },
  { key: "staff-schedule", label: "Lịch công tác" },
  { key: "lesson-plans", label: "Quản lý Giáo án" },
  { key: "exams", label: "Khảo thí & Thi cử" },
  { key: "communication-conduct", label: "Sổ liên lạc & Nề nếp" },
  { key: "letters", label: "Quản lý Thư từ" },
  { key: "meals", label: "Dịch vụ Bếp ăn / Bán trú" },
  { key: "transport", label: "Xe đưa đón" },
  { key: "health", label: "Y tế học đường" },
  { key: "tickets", label: "Hỗ trợ / Ticket" },
  { key: "knowledge", label: "Thư viện Tri thức (SOP, Quy chế)" },
  { key: "media", label: "Truyền thông & Media" },
  { key: "plans", label: "Kế hoạch & Dự báo" },
  { key: "departments", label: "Sơ đồ Tổ chức & Phòng ban" },
  { key: "subject-groups", label: "Tổ bộ môn" },
  { key: "system-data", label: "Dữ liệu hệ thống" },
  { key: "reports", label: "Trung tâm báo cáo" },
  { key: "system-settings", label: "Cấu hình hệ thống" },
...
const DEPARTMENTS_LIST = [
  ...
  { id: "dept_hanhchinh", name: "Hành chính - Tổng hợp", code: "HANH_CHINH" },
  { id: "dept_ketoan", name: "Kế toán / Tài chính", code: "KE_TOAN" },
  { id: "dept_dichvu", name: "Dịch vụ Học đường", code: "DICH_VU" },
  { id: "dept_yte", name: "Y tế học đường", code: "Y_TE" },
  { id: "dept_truyenthong", name: "Truyền thông / Marketing", code: "TRUYEN_THONG" },
  { id: "dept_it", name: "IT / Hệ thống", code: "IT" },
