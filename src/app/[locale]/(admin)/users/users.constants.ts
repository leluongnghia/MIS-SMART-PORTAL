...
export const PERMISSION_MODULES = [
  ...
  { key: "conduct", label: "Đánh giá Hạnh kiểm" },
  { key: "communication-book", label: "Sổ liên lạc điện tử" },
  { key: "letters", label: "Quản lý Thư từ" },
  { key: "school-services", label: "Tổng quan Dịch vụ Học đường" },
  ...
  { key: "storage", label: "Lưu trữ & Dữ liệu" },
